function init () {
    ...
    var plan = L.esri.tiledMapLayer({
        url:"https://tiles.arcgis.com/tiles/8uevmRlLsZdoxHk8/arcgis/rest/services/tile_package_plan/MapServer"
       }).addTo(map);
    ...
    // ajouter une échelle a la carte
